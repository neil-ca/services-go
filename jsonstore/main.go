...
import (
	"encoding/json"
	"github.com/Neil-uli/Restful-go/jsonstore/models"
...
// DB store the database session information. Needs to be initialized once
...
// PostUser add URL to DB and gives back shortened string
